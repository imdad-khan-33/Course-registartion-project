      ...
      <div className='max-w-4xl mx-auto pt-12 md:pt-0'>
        ...
        <div className='bg-white rounded-3xl shadow-xl p-8 border border-white/50'>
          <form onSubmit={handlePublish}>
            ...
            <div className='mb-8'>
              <div className='flex items-center gap-3 mb-6'>
                <div className='w-10 h-10 rounded-xl bg-linear-to-r from-pink-500 to-rose-500 flex items-center justify-center'>
              ...
              <div 
                ...
                className={`relative cursor-pointer border-4 border-dashed rounded-2xl p-8 transition-all duration-300 ${
                  previewImage 
