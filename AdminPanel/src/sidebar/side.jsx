  ...
  return (
    <div className='relative w-full h-full py-4 px-4 bg-[#F7FAFA]'>
      ...
      <div className='flex flex-col h-full sm:pt-0 pt-4'>
        ...
        <NavLink to="/dish" end className={({ isActive }) => `text-[14px] font-[500] ${isActive ? "bg-[#E8EDF2]" : "text-[#858585]"}`}><div className='flex gap-3 w-full py-1.5 px-2.5'>
        ...
        <div className='mt-auto flex gap-3 logout'>
          ...
          <p className='text-[#0D121C] text-[14px] font-[500]'>Log Out</p>
        </div>
      </div>
      <div>
